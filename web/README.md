...
기준 문서: [`../Branreach_PRD.md`](../Branreach_PRD.md) (제품 요구사항). PRD에 없는 기능은 임의로 추가하지 않는다.

> 이 폴더(`web/`)가 앱 루트입니다. 모든 명령은 이 폴더에서 실행하세요.
> Vercel 배포 시 **Root Directory 를 `web` 으로 설정**해야 합니다.
